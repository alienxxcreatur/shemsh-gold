...
| BASE-FDB-01 | Alert | ۱ | خطا، هشدار، محدودیت و Context مالی | info, warning, danger, success, neutral | Confirmed | `Candidate v0.1` در صفحه مستقل `16 Alert` با ۱۰ Variant `Tone × Layout`، هفت Property عمومی و audit صفر Issue؛ منتظر تأیید بصری |
...
| BASE-FDB-03 | Toast | ۱ | Copy، ذخیره و بازخورد کوتاه غیرحیاتی | neutral, info, success, warning, danger | Confirmed | `Candidate v0.1` در صفحه مستقل `17 Toast` با ۵ Tone، چهار Property عمومی، Token binding معنایی و Final technical/visual QA صفر Issue؛ منتظر تأیید بصری |
