...
|---|---|---|---|
| Color | Semantic colors برای Surface، Text، Brand، Success، Warning، Error | باز | کنتراست Light/Dark |
| Typography | مقیاس فارسی، وزن‌ها، اعداد Tabular | باز | خوانایی و Dynamic Type |
| Spacing | ریتم 4/8 | باز | ثبات صفحه و کامپوننت |
| Radius | مقیاس محدود | باز | هماهنگی حس برند |
