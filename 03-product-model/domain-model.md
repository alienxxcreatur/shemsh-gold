...
| `InternalAccountNumber` | شماره حساب داخلی یکتای کاربر برای شناسایی مبدأ انتقال درون برنامه | دقیقاً متعلق به یک حساب و قابل‌نمایش در رسید انتقال | سرویس حساب |
...
|---|---|---|---|
| `GoldReceiveIdentifier` | شناسه قابل اشتراک برای یافتن گیرنده، متصل به حساب احرازشده | فقط نام تأییدشده گیرنده پیش از تأیید نمایش داده می‌شود؛ موبایل و کد ملی افشا نمی‌شوند | سرویس انتقال |
...
- پیش از تأیید هیچ طلایی رزرو نمی‌شود؛ انتقال موفق باید به‌صورت اتمیک از حساب فرستنده کسر و به حساب گیرنده اضافه شود.
- گیرنده در جزئیات انتقال نام فرستنده و `InternalAccountNumber` مبدأ را می‌بیند.
...
| انتقال طلا | درحال انجام ← تأیید نهایی بدون رزرو | انجام‌شده با ثبت اتمیک دوطرفه؛ ناموفق بدون تغییر موجودی |
...
- پس از آزادسازی، طلا قابل فروش، انتقال یا درخواست تحویل فیزیکی است.
