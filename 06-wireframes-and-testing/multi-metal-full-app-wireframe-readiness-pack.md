...
| `MM-W6` | `023A..B` + `024` | ۷۵٪ | مقصد واحد دوحالته و هر دو مسیر ساخته شده‌اند؛ D-164..D-168 فرم/قرارداد جدید و D-171 قرارداد فعال را پوشش می‌دهند. «قسط‌های من» Tabهای ماندگار قرارداد، جاری با Summary/Next/Schedule/Detail، اتصال رسید/پرداخت، Payment review و Result به‌روزشده دارد. داده‌های نرخ/هزینه/دیرکرد/فسخ Candidate و قواعد مالی/حقوقی بازند |
