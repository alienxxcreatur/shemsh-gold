...
| `WF-MM-023B` | اقساط — بدون قرارداد فعال | Asset Tab مشترک معامله، Slider مبلغ Candidate از ۱۰ تا ۱۰۰ میلیون و دوره‌های Candidate شش/دوازده‌ماهه با محاسبه زنده نرخ ۲۳٪ | خدمات/ستون سناریو | `WF-MM-024` Preview/نتیجه آزمایشی؛ D-089/OQ-005 هنوز قانون رسمی را کنترل می‌کنند |
| `WF-MM-024` | Preview/نتیجه اقساط | سنجش قفل دارایی و قرارداد پس از فرم حالت بدون قرارداد | `WF-MM-023B` | نتیجه آزمایشی؛ بدون ادعای عرضه |
...
| `MM-W2` | `008..012` | ۷۵٪ | پنج خروجی معامله/Asset Tabs/Catalog/Quote/Chart ساخته شده‌اند؛ Entry معامله طبق D-157/D-158 با Tab متنی، نرخ/جهت فشرده، موجودی Contextual، عدد مرکزچین، تبدیل مستقیم تومان/گرم و کیبورد همیشه‌باز در Portrait بدون اسکرول است؛ راهنما/Preset حذف و Error نزدیک ورودی حفظ شده است |
...
| `MM-W6` | `023A..B` + `024` | ۷۵٪ | مقصد واحد اقساط با دو حالت قرارداد فعال/بدون قرارداد و مسیر درخواست/Preview ساخته شده؛ قواعد مالی/حقوقی بازند |
