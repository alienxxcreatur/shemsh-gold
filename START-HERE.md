...
- وضعیت: **Gate 4 با نتیجه Sufficient to proceed بسته شده؛ نسخه اولیه فلو ورود/ثبت‌نام کامل شده و برای اتصال به احراز کافی است**
- قدم بعدی: تکمیل فلو احراز هویت و سپس ادامه موج ۱ با قیمت و ماشین‌حساب
