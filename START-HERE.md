...
- مرحله فعال: **مرحله ۳ — مدل محصول**
- زیرمرحله فعال: **مدل دامنه و موجودیت‌ها**
- وضعیت: **زیرمرحله قواعد با نتیجه Sufficient to proceed بسته شده؛ Gate 3 در حال انجام است**
- قدم بعدی: تکمیل موجودیت‌ها، روابط، منبع حقیقت داده و transitionهای status در `03-product-model/domain-model.md`
